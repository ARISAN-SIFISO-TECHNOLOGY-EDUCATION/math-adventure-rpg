...
export default function Grade11Page() {
  return (
    <div className="font-[Inter] bg-gradient-to-br from-[#FEF2F2] to-[#F0FDFA] text-gray-800 min-h-screen">
      <Navbar breadcrumb="Grade 11" accentColor="#B91C1C" borderColor="#FCA5A5" />
      ...
      <section className="py-16 text-center px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-[Nunito] text-5xl font-extrabold leading-tight mb-4"
            ...
            ⚒️ Grade 11<br />School of Mastery
          </h1>
          <p className="text-lg text-gray-500 max-w-xl mx-auto mb-8">
            Deepen the FET skills. Surds and quadratics, the nature of roots, shifted functions,
