    ...
    topics: [
      {
        ...
        subtitle: 'Identities · Equations · Radians',
        icon: '🌊',
        color: 'bg-sprout-blue',
        levels: 3,
        hasTest: true,
      },
      {
        id: 'age16-calculus',
        title: 'Calculus',
        subtitle: 'First Principles · Basic Differentiation',
        icon: '∫',
        color: 'bg-sprout-purple',
        levels: 2,
        hasTest: true,
      ...
      },
      {
        id: 'age16-algebra3',
        title: 'Algebra III',
        subtitle: 'Polynomial Division · Advanced Logs',
        icon: '🧮',
        color: 'bg-teal',
        levels: 2,
        hasTest: true,
      },
      {
        id: 'age16-functions2',
        title: 'Functions II',
        subtitle: 'Transformations · Inverse Functions',
        icon: '🔁',
        color: 'bg-sprout-pink',
        levels: 2,
        hasTest: true,
      },
      {
        ...
        subtitle: 'Equation of Line · 2D Vectors',
        icon: '📌',
        color: 'bg-sprout-green',
        levels: 2,
        hasTest: true,
      },
      {
        id: 'age16-stats2',
        title: 'Statistics II',
        subtitle: 'Standard Deviation · Conditional Probability',
        icon: '📉',
        color: 'bg-sprout-gold',
        levels: 2,
        hasTest: true,
