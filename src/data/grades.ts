...
export const GRADES: GradeConfig[] = [
  ...
  },
  {
    ...
    ages: 'Age 15',
    levels: 15,
    description: '3 worlds, 15 levels — FET algebra, functions, trigonometry, analytical & Euclidean geometry, finance and statistics.',
    ...
    tip: 'Senior phase begins — CAPS FET Grade 10 content for Age 15.',
  },
  {
    phase: 8,
    emoji: '⚒️',
    ...
    tip: 'CAPS FET Grade 11 — quadratics and circle geometry for Age 16.',
  },
  {
    phase: 9,
    emoji: '🎓',
    ...
    topics: ['Sequences, series & finance', 'Differential calculus & functions', 'Circle geometry, trig & stats', 'Matric apex boss'],
    detailLink: '/grade12',
    playLink: '/play?phase=9',
    tip: 'Matric — sequences, calculus and the final apex for Age 17.',
  },
];
